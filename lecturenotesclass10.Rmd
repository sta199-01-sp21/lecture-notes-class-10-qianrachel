...
How close is this value to the "true" probability? It's pretty close to the "true" probability.
...
Before we do this, what is your guess as to what the probability will be? It should be less likely that we draw two marbles of the same color with replacement.
